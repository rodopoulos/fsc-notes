...
\begin{itemize}
  ...
  \item \textbf{\textit{vm\_copy}:} copia um objeto da memória de uma região par a outra. Como otimização, ele implementa o \textit{copy on write}, onde % TODO: ver o que é isso e por figura
