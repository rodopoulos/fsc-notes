...
Esta operação desfaz o \textit{link} explicado anteriormente, removendo a entrada do descritor do arquivo solicitado da \textit{tabela de arquivos abertos do processo} e o descritor do arquivo na entrada do processo solicitante na \textit{tabela de processos}. Todos os acessos subsequentes ao descritor e arquivo serão invalidados.
