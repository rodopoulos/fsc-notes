...
\begin{itemize}
  \item \textbf{Tabela de Arquivos:} uma tabela global do sistema, onde existe uma entrada para cada arquivo, contendo as informações referentes a cada umm organizada em diretórios;
